...
public class CopyOfCopyOfStringRotation {
	...
	public static void main(String[] args) {
		...
		System.out.println(new CopyOfCopyOfStringRotation().isRotation("harry potter",
				"terharry pot"));
		System.out.println(new CopyOfCopyOfStringRotation().isRotation("bottle", "txybzw"));
		System.out.println(new CopyOfCopyOfStringRotation().isRotation("hello", "lohell"));
		System.out.println(new CopyOfCopyOfStringRotation().isRotation("hello", "hello"));
		System.out.println(new CopyOfCopyOfStringRotation().isRotation("hello", "lohe"));
