...
public class CopyOfStringRotation {
	...
	public static void main(String[] args) {
		...
		System.out.println(new CopyOfStringRotation().isRotation("harry potter",
				"terharry pot"));
		System.out.println(new CopyOfStringRotation().isRotation("bottle", "txybzw"));
		System.out.println(new CopyOfStringRotation().isRotation("hello", "lohell"));
		System.out.println(new CopyOfStringRotation().isRotation("hello", "hello"));
		System.out.println(new CopyOfStringRotation().isRotation("hello", "lohe"));
